...
class SimpleMovieDetail extends Component {
	render() {
		return (
			<div className='movie-detail col-sm-12 col-md-8'>
				...
				<p><strong>Writer:</strong> Michael Crichton (novel), Michael Crichton (screenplay), David Koepp
					(screenplay)</p>
...
SimpleMovieDetail.label = 'Simple Movie Detail';

export default SimpleMovieDetail;